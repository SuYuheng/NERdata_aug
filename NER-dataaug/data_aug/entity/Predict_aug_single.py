...
model_name = '../pre_model/pre_train'
...
if __name__ == '__main__':
    ...
    with open("../data/pre_single/0.3/train.txt", 'a', encoding='utf-8') as f:
        for i in range(len(sentences)):
            ...
            # print(len(labels[i]))
            new_word, new_label = synonym_replacement(sentences[i], 0.3, labels[i])  # 设置增广的比例
